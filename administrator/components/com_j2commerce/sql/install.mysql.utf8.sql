...
-- Tags for the transactional type are derived from MessageHelper by
-- EmailTypeRegistry::getCoreTags(); only plugin-registered types seed rows here.
