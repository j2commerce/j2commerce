...
class PricecalculatorField extends ListField
{
    ...
    public function getOptions(): array
    {
        ...
        try {
            ...
            Log::add('Failed to load pricing calculators: ' . $e->getMessage(), Log::ERROR, 'com_j2commerce');

            Factory::getApplication()->enqueueMessage(
                Text::sprintf('COM_J2COMMERCE_ERROR_LOADING_PRICING_CALCULATORS', Text::_('JERROR_AN_ERROR_HAS_OCCURRED')),
                'error'
            );
        }
