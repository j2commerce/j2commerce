...
namespace J2Commerce\Component\J2commercemigrator\Administrator\View\Connection;
...
class HtmlView extends BaseHtmlView
{
    ...
    public bool   $pdoAvailable   = false;
    ...
    public function display($tpl = null): void
    {
        ...
        $this->pdoAvailable    = extension_loaded('pdo_mysql');
    ...
    private function setToolbar(): void
    {
        ...
        $toolbar->title(Text::_('COM_J2COMMERCEMIGRATOR_VIEW_CONNECTION_TITLE'), 'fa-solid fa-plug');
        $toolbar->link(
    ...
    private function loadAssets(): void
    {
        ...
        $wa->registerAndUseScript(
            'com_j2commercemigrator.migrator-connection',
            'media/com_j2commercemigrator/js/administrator/migrator-connection.js',
            [],
            ['defer' => true]
        );
