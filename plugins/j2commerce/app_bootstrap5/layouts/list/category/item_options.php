...
<div class="j2commerce-product-options py-2" id="product-options-<?php echo $productId; ?>">
    ...
    <div class="<?php echo $collapsedOptions ? 'collapse ' : ''; ?>pt-2" id="collapseOptions<?php echo $productId; ?>">
        ...
        <?php if ($option['type'] == 'checkbox' && isset($option['optionvalue']) && !empty($option['optionvalue'])) : ?>
            <fieldset id="option-<?php echo $optionId; ?>" class="option mb-3 j2commerce-option-group" data-config-checkbox="1" data-product-id="<?php echo $productId; ?>" data-po-id="<?php echo $optionId; ?>"<?php echo ProductLayoutService::optionDescribedBy($option); ?>>
