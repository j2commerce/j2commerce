...
?>
<div class="j2commerce j2commerce-tags bootstrap5 <?php echo $this->escape($params->get('pageclass_sfx', '')); ?>">
        ...
        <?php else : ?>
            ...
            <?php if ($displayMode === 'products') : ?>
                ...
                <?php if (!empty($this->items)) : ?>
                    <div class="j2commerce-category-grid row row-cols-1 row-cols-sm-2 row-cols-md-<?php echo $colsMd; ?> row-cols-lg-<?php echo $tag_columns; ?> gy-4 mb-4">
                        ...
                        ?>
                            <div class="col">
                                <div class="j2commerce-category-card hover-effect-scale">
                                    <?php if ($hasImage) : ?>
                                    <a href="<?php echo $tagUrl; ?>" class="d-block bg-body-tertiary rounded p-4 mb-3">
                                    ...
                                    <h2 class="j2commerce-category-title d-flex w-100 pb-2 mb-1 fs-3">
                                        <a class="animate-underline animate-target d-inline text-truncate"
                                           href="<?php echo $tagUrl; ?>"><?php echo $this->escape($tag->title); ?></a>
                                    </h2>
