                            ...
                            <div id="filterPf-<?php echo $filterScriptId; ?>" class="accordion-collapse collapse<?php echo $pfShowExpanded ? ' show' : ''; ?>">
                                <div class="accordion-body">
                                    ...
                                    <div id="j2commerce-pf-filter-<?php echo $filterScriptId; ?>" class="j2commerce-productfilter-list<?php echo $pfInputType === 'color' ? ' j2commerce-filter-swatches d-flex flex-wrap gap-2' : ''; ?>">
                                        <?php if ($pfIsList) : ?>
                                            <select class="form-select form-select-sm j2commerce-pfilter-select j2commerce-pfilter-select-<?php echo $filterScriptId; ?>" name="productfilter_ids[]" aria-label="<?php echo $this->escape(Text::_($filtergroup['group_name'])); ?>"<?php echo $pfInputType === 'multiselect' ? ' multiple size="' . min(count($filtergroup['filters']), 8) . '"' : ''; ?>>
