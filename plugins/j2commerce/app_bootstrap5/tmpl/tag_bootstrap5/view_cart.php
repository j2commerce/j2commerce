    ...
    <div id="add-to-cart-<?php echo $productId; ?>" class="j2commerce-add-to-cart pt-3">
        ...
        <div class="product-add-to-cart-group">
            ...
            <button
                ...
                type="submit"
                class="j2commerce-cart-button w-100 <?php echo htmlspecialchars($this->params->get('addtocart_button_class', 'btn btn-primary'), ENT_QUOTES, 'UTF-8'); ?><?php echo $purchasable ? '' : ' j2commerce-out-of-stock'; ?>"<?php echo $purchasable ? '' : ' disabled'; ?>
            >
