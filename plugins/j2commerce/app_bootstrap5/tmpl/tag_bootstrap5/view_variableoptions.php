                ...
                <div class="j2commerce-radio-options d-flex flex-wrap gap-2" data-binded-label="#radioOption<?php echo $option['productoption_id']; ?>">
                    <?php foreach ($option['optionvalue'] as $optionValue) : ?>
                        ...
                        <?php if ($showOptionImages && !empty($optionValue['optionvalue_image'])) : ?>
                            <label class="btn btn-image p-0 form-check-label border-2" for="option-value-<?php echo $optionValue['product_optionvalue_id']; ?>" data-label="<?php echo $esc(J2htmlHelper::translateKey($optionValue['optionvalue_name'])); ?>">
                        ...
                        <?php else : ?>
                            <label class="btn btn-sm btn-outline-secondary form-check-label border-2" for="option-value-<?php echo $optionValue['product_optionvalue_id']; ?>" data-label="<?php echo $esc(J2htmlHelper::translateKey($optionValue['optionvalue_name'])); ?>">
                                <?php echo $esc(J2htmlHelper::translateKey($optionValue['optionvalue_name'])); ?>
                                <?php if ($optionValue['product_optionvalue_price'] > 0 && $this->params->get('product_option_price', 1)) : ?>
                                    <?php if ($this->params->get('product_option_price_prefix', 1)) : ?>
                                        <?php echo $esc($optionValue['product_optionvalue_prefix']); ?>
