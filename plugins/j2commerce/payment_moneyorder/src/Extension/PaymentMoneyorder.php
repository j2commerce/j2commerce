...
final class PaymentMoneyorder extends CMSPlugin implements SubscriberInterface
{
    ...
    public function onGetPaymentPlugins(Event $event): void
    {
        ...
        $result[] = [
            'element' => $this->_name,
            'name'    => J2htmlHelper::translateKey($this->params->get('display_name', 'PLG_J2COMMERCE_PAYMENT_MONEYORDER')),
    ...
    public function _prePayment(array $data): string
    {
        ...
        $vars->display_name           = J2htmlHelper::translateKey($this->params->get('display_name', 'PLG_J2COMMERCE_PAYMENT_MONEYORDER'));
