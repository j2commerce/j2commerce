...
final class PaymentBanktransfer extends CMSPlugin implements SubscriberInterface
{
    ...
    public function onGetPaymentPlugins(Event $event): void
    {
        ...
        $result[] = [
            ...
            'name'    => J2htmlHelper::translateKey($this->params->get('display_name', 'PLG_J2COMMERCE_PAYMENT_BANKTRANSFER')),
    ...
    private function prePayment(array $data): string
    {
        ...
        $vars->display_name         = J2htmlHelper::translateKey($this->params->get('display_name', 'PLG_J2COMMERCE_PAYMENT_BANKTRANSFER'));
