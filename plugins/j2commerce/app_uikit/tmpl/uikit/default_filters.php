                        ...
                        <li<?php echo $pfShowExpanded ? ' class="uk-open"' : ''; ?>>
                            ...
                            <div class="uk-accordion-content">
                                ...
                                <div id="j2commerce-pf-filter-<?php echo $filterScriptId; ?>" class="j2commerce-productfilter-list<?php echo $pfInputType === 'color' ? ' j2commerce-filter-swatches' : ''; ?>">
                                    <?php if ($pfIsList) : ?>
                                        <select class="uk-select uk-form-small j2commerce-pfilter-select j2commerce-pfilter-select-<?php echo $filterScriptId; ?>" name="productfilter_ids[]" data-group-alias="<?php echo $this->escape($groupAlias); ?>" aria-label="<?php echo $this->escape(Text::_($filtergroup['group_name'])); ?>"<?php echo $pfInputType === 'multiselect' ? ' multiple size="' . min(count($filtergroup['filters']), 8) . '"' : ''; ?>>
