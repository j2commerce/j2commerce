        ...
        <?php foreach ($options as $option) : ?>
            ...
            <?php if ($option['type'] === 'select') : ?>
                ...
                <div id="option-<?php echo $optionId; ?>" class="option uk-margin-small-bottom">
                    ...
                    <select<?php echo ProductLayoutService::optionDescribedBy($option); ?> id="<?php echo $selectInputId; ?>" name="product_option[<?php echo $optionId; ?>]" data-is-variant="<?php echo !empty($option['is_variant']) ? '1' : '0'; ?>" class="uk-select" onchange="doAjaxPrice(<?php echo (int) $productId; ?>, 'option-<?php echo $optionId; ?>')">
