        ...
        <?php if ($option['type'] === 'select') : ?>
            ...
            <div id="option-<?php echo $optionId; ?>" class="option uk-margin-small-bottom">
                ...
                <?php echo ProductLayoutService::renderLayout('productoption.description', [
                    ...
                    <select<?php echo ProductLayoutService::optionDescribedBy($option); ?> id="<?php echo $selectInputId; ?>" name="product_option[<?php echo $optionId; ?>]" class="uk-select" onchange="doFlexiAjaxPrice(<?php echo $productId; ?>, '#option-<?php echo $optionId; ?>')">
