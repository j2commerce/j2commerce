                ...
                <div class="j2commerce-radio-options d-flex flex-wrap gap-2" data-binded-label="#child-radioOption<?php echo $optionId; ?>">
                    <?php foreach ($option['optionvalue'] as $option_value) : ?>
                        ...
                        <?php if ($params->get('image_for_product_options', 0) && !empty($option_value['optionvalue_image'])) : ?>
                            <label class="btn btn-image p-0 form-check-label border-2" for="<?php echo $childOptionValueInputId; ?>" data-label="<?php echo $esc(J2htmlHelper::translateKey($option_value['optionvalue_name'])); ?>">
                        ...
                        <?php else : ?>
                            <label class="btn btn-sm btn-outline-secondary form-check-label border-2" for="<?php echo $childOptionValueInputId; ?>" data-label="<?php echo $esc(J2htmlHelper::translateKey($option_value['optionvalue_name'])); ?>">
                                <?php echo $esc(J2htmlHelper::translateKey($option_value['optionvalue_name'])); ?>
                                <?php if ($option_value['product_optionvalue_price'] > 0 && $params->get('product_option_price', 1)) : ?>
                                    <?php if ($params->get('product_option_price_prefix', 1)) : ?>
                                        <?php echo $esc($option_value['product_optionvalue_prefix']); ?>
            ...
            <fieldset id="child-option-<?php echo $optionId; ?>" class="option mb-3 j2commerce-option-group"<?php echo ProductLayoutService::optionDescribedBy($option); ?>>
                ...
                <div class="j2commerce-color-options d-flex flex-wrap gap-2" data-binded-label="#child-colorOption<?php echo $optionId; ?>">
                    <?php foreach ($option['optionvalue'] as $option_value) : ?>
                        ...
                        <label for="<?php echo $childOptionValueInputId; ?>" class="btn btn-color fs-xl" title="<?php echo $esc(J2htmlHelper::translateKey($option_value['optionvalue_name'])); ?>" data-label="<?php echo $esc(J2htmlHelper::translateKey($option_value['optionvalue_name'])); ?>"<?php if ($swatchColor !== '') : ?> style="color:<?php echo $esc($swatchColor); ?>;"<?php endif; ?>>
                            <span class="visually-hidden"><?php echo $esc(J2htmlHelper::translateKey($option_value['optionvalue_name'])); ?></span>
                        </label>
                    <?php endforeach; ?>
                </div>
