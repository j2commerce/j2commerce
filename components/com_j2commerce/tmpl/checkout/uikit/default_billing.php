...
<?php endif; ?>
    ...
    <div class="uk-margin">
        <label class="uk-flex uk-flex-middle">
            <input class="uk-checkbox uk-margin-small-right" type="checkbox" name="shipping_address" value="1" id="shipping-same-as-billing"<?php echo $shipSameAsBilling ? ' checked' : ''; ?>>
