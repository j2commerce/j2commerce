...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function showLoading(btn) {
        ...
        var ring = J2CommerceDom.el('span', {class: 'spinner-border spinner-border-sm', role: 'status'});
        ring.appendChild(J2CommerceDom.el('span', {class: 'visually-hidden'}, <?php echo $loadingJs; ?>));
        spinner.append('\u00a0', ring);
            ...
            if (json.hasSteps) {
                ...
                if (section) {
                    ...
                    if (content) {
                        ...
                        var continueWrap = J2CommerceDom.el('div', {class: 'mt-3'});
                        continueWrap.appendChild(J2CommerceDom.el('button', {
                            id: 'button-custom-steps',
                            type: 'button',
                            class: 'btn btn-primary btn-checkout-step',
