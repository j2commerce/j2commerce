...
(() => {
    ...
    function updateKPIs(data) {
        ...
        const ordersExcludedEl = document.getElementById('kpi-orders-excluded');
        if (ordersExcludedEl) ordersExcludedEl.textContent = excludedText(data.excludedOrderCount);
